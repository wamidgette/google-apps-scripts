...
function getSignedJWT() {
  try {
    ...
    let jsrsasign = eval(UrlFetchApp.fetch("https://kjur.github.io/jsrsasign/jsrsasign-latest-all-min.js").getContentText())
    ...
    signedJWT = KJUR.jws.JWS.sign('PS256',stringifiedJwtHeader,stringifiedJwtPayload,secret);
